...
//	if(strlen(nonce)>=32)
	{		
		len_total +=sprintf(&sttp_buf[len_total],"Authorization: Basic YWRtaW46MTIzNDU=\r\n");	
...
//int camera_authorization_get(char *sttp_buf,const char *method,const char *uri)
//{
